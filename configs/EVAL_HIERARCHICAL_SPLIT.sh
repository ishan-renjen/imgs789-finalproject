...
#     --pretrain '/home/inr8842/OWOD-semantic-unknown-labels/exps/hypow_t1_hierarchical_split.pth' --eval --wandb_project ""\
...
python -u main_open_world.py \
    ...
    --pretrain  '/home/inr8842/OWOD-semantic-unknown-labels/exps/hypow_t2_ft_hierarchical_split.pth'  --eval --wandb_project ""\
     --wandb_project '' --lr_drop 40  --num_queries 100 --logging_freq 40 --use_focal_cls  \
    --save_buffer  --relabel  --eval \
    --epochs 50  --clip_r 1.0 --use_hyperbolic --unknown_weight 0.1  \
    --hyperbolic_c 0.1 --hyperbolic_temp 0.2 --samples_per_category 1 --hyperbolic_coeff 0.05 --checkpoint_period 10 --start_relabelling 0 --emb_per_class 10 \
...
python -u main_open_world.py \
    ...
    --train_set "t1_train_hierarchical" --test_set 'hierarchical_test' --epochs 191 --lr_drop 35\
    --model_type 'hypow' --obj_loss_coef 8e-4 --obj_temp 1.3\
    --pretrain '/home/inr8842/OWOD-semantic-unknown-labels/exps/hypow_t3_ft_hierarchical_split.pth' --eval --wandb_project ""\
    --wandb_project '' --lr_drop 40  --num_queries 100 --logging_freq 40 --use_focal_cls  \
    --save_buffer  --relabel  --eval \
    --epochs 50  --clip_r 1.0 --use_hyperbolic --unknown_weight 0.1  \
    --hyperbolic_c 0.1 --hyperbolic_temp 0.2 --samples_per_category 1 --hyperbolic_coeff 0.05 --checkpoint_period 10 --start_relabelling 0 --emb_per_class 10 \
...
python -u main_open_world.py \
    ...
    --train_set "t1_train_hierarchical" --test_set 'hierarchical_test' --epochs 191 --lr_drop 35\
    --model_type 'hypow' --obj_loss_coef 8e-4 --obj_temp 1.3\
    --pretrain '/home/inr8842/OWOD-semantic-unknown-labels/exps/hypow_t4_ft_hierarchical_split.pth' --eval --wandb_project ""\
